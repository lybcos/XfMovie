 ...
 */
package com.example.administrator.xfmovie.library;
...
public class WaveView extends View {
     ...
     * +------------------------+__|____
     */
    public static final float DEFAULT_AMPLITUDE_RATIO = 0.05f;//波浪波峰的高度
    private static final float DEFAULT_WATER_LEVEL_RATIO = 0.5f; //破浪所处的位置，默认中间位置
    ...
    private ArrayList<ItemWave> listWaves;//波浪Item
    ...
    public void setWaveColor(ArrayList<ItemWave> list) {
        this.listWaves.clear();
        if (list == null || list.size() == 0) {
            return;
        }
        this.listWaves.addAll(list);
    ...
    //mDefaultAmplitude 0.01-0.10
    public void setmDefaultAmplitude(float mDefaultAmplitude) {
